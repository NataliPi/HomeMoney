...
public abstract class PickerDialog extends Dialog {
    ...
    NumberPicker[] integerNumberPickers;
    NumberPicker[] decimalNumberPickers;
    protected String[] values = null;
    protected String[] secondaryValues = null;
    ...
    public PickerDialog(Context context, String dialogTitle, float startValue, int integerNumberPickersCount, int decimalNumberPickersCount) {
        ...
        init(context, dialogTitle, startValue, integerNumberPickersCount, decimalNumberPickersCount);
    }

    public PickerDialog(Context context, String dialogTitle, int startValue, String[] values) {
        super(context);
        this.values = values;
        init(context, dialogTitle, startValue, 1, 0);
    }

    public PickerDialog(Context context, String dialogTitle, int startValue, String[] primaryValues, String[] secondaryValues) {
        super(context);
        this.values = primaryValues;
        this.secondaryValues = secondaryValues;
        init(context, dialogTitle, startValue, 2, 0);
    }

    public void init(Context context, String dialogTitle, float startValue, int integerNumberPickersCount, int decimalNumberPickersCount) {
        ...
        integerNumberPickers = new NumberPicker[integerNumberPickersCount];
        decimalNumberPickers = new NumberPicker[decimalNumberPickersCount];
    ...
    public NumberPicker[] getIntegerNumberPickers() {
        return integerNumberPickers;
    }

    public NumberPicker[] getDecimalNumberPickers() {
        return decimalNumberPickers;
    }
    ...
    private void initializeNumberPickers(@NonNull Context context, @NonNull LinearLayout pickersLayout, @NonNull final NumberPicker[] integerNumberPickers, @NonNull final NumberPicker[] decimalNumberPickers) {
        ...
        for (int i = 0; i < integerNumberPickers.length; i++) {
            ...
            if (integerNumberPickers.length > 1) {

                params.weight = 1.0f / (float) integerNumberPickers.length;

            }
            integerNumberPickers[i].setLayoutParams(params);
     ...
     * @see #onNumberPickersValuesChange(NumberPicker[], NumberPicker[])
     */
    protected void setValueForNumberPickers(@NonNull NumberPicker[] integerNumberPickers, @NonNull NumberPicker[] decimalNumberPickers, @NonNull int[] integerValue, @NonNull int[] decimalValue) {
